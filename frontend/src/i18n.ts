...
export const STRINGS = {
  vi: {
    ...
    // connection tab
    seConnectTitle: 'Kết nối tài khoản mới', seConnectSub: 'Kết nối tài khoản mạng xã hội để quản lý và đăng bài dễ dàng hơn.',
    ...
    seInfoTitle: 'Thông tin về trạng thái kết nối',
  ...
  en: {
    ...
    // connection tab
    seConnectTitle: 'Connect a new account', seConnectSub: 'Connect your social media accounts to manage and publish content easily.',
    ...
    seInfoTitle: 'Connection status information',
